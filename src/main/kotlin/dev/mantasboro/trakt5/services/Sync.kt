...
import dev.mantasboro.trakt5.entities.LastActivities
...
interface Sync {
    ...
    fun addItemsToCollection(@Body items: SyncItems): Call<SyncResponse>
     ...
     */
    @POST("sync/ratings")
    fun addRatings(@Body items: SyncItems?): Call<SyncResponse>
     ...
     */
    @POST("sync/watchlist")
    fun addItemsToWatchlist(@Body items: SyncItems?): Call<SyncResponse>
    ...
    fun deleteItemsFromWatchlist(@Body items: SyncItems?): Call<SyncResponse>
}
